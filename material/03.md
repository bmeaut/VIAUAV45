...
following functionalities straightforward:
...
a [`ThemeData`](https://api.flutter.dev/flutter/material/ThemeData-class.html), but *swatches* can also be used. A *swatch* is a collection of color shades generated (and for built-in swatches, hardcoded) from a base color. A *swatch* is a *color palette*.
