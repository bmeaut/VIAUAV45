...
For our last project, let's take a look into the [`flutter_dio_retrofit`](../projects/chapters/chapter_08/flutter_dio_retrofit) project to see how the `dio` library can generate code from a Retrofit-like interface description.
