...
Take a look into the [`flutter_counter_cubit`](https://github.com/bmeaut/VIAUAV45/projects/chapters/chapter_05/flutter_counter_cubit) project to see how we can enhance the Counter application with `Cubit`s.
...
Take a look into the [`flutter_counter_bloc`](https://github.com/bmeaut/VIAUAV45/projects/chapters/chapter_05/flutter_counter_bloc) project to see how we can enhance the Counter application further with `Bloc`s.
